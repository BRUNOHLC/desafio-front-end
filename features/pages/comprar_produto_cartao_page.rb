class HomePageCadastro < SitePrism::Page
  ...
  element :bt_pagamento_cartao, ".bankwire"
  element :bt_concluir_pagamento_cartao, "button.button-medium > span:nth-child(1) > i:nth-child(1)"
  #Metodos
  ...
  def Pagamento_Cartao
    bt_pagamento_cartao.click
    bt_concluir_pagamento_cartao.click
  end
end
